...
@section('content')
	<form id="regForm" action="/action_page.php" >
	  ...
	  <div class="tab">
		...
		<span>Postcode</span>
	    <p><input placeholder="Please enter" oninput="this.className = '' "name="postcode"></p>
	  </div>
	  ...
	  <div class="tab">
	    ...
	    <p class="text-center">
	    	<input type="radio" id="yes" name="" value="yes" style="width: 2%">
			<label for="yes">Yes</label><br>
			<input type="radio" id="no" name="" value="no" style="width: 2%">
			<label for="no">No</label>
	    </p>
	  </div>
	  ...
	  <div class="tab">
	    ...
	    <p class="text-center">
	    	<input type="checkbox" id="" name="" value="" style="width: 2%">
